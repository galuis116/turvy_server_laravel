...
Route::get('/settings/pusherinfo', 'API\CommonController@pusherinfo');
...
Route::group(['prefix' => 'rider'], function(){
    ...
    Route::post('/delete-account-check', 'API\RiderController@deleteAccountCheck');
    ...
    Route::group(['middleware' => 'auth:api'], function(){
        ...
        Route::post('/delete-account', 'API\RiderController@deleteAccount');
    });
});
...
Route::group(['prefix' => 'driver'], function(){
    ...
    Route::post('/delete-account-check', 'API\DriverController@deleteAccountCheck');
