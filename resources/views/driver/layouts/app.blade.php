                    ...
                    <div class="col-md-3 hidden-xs">
                        ...
                        <ul class="nav tabs-vertical left_tab">
                            ...
                            @if($driver->avatar == '')
                                ...
                                <li class="driver_profile"> <img class="col-md-4 col-sm-4 col-xs-4"  src="{{asset('images/no-person.png')}}"/>

                            @else

                                <li class="driver_profile"> <img class="col-md-4 col-sm-8 col-xs-8" src="{{asset($driver->avatar)}}">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-8 driver_info">
                                        ...
                                        <div class="driver_car_name">{{$driver->mobile}}</div>

                                        <div class="driver_car_number">{{$driver->vehicle->plate}}</div>

                                        <div class="driver_rating">
											@for($i=0;$i<$driver_rate;$i++)
											<i class="fa fa-star"></i>
											@endfor
											@for($i=0;$i<5-$driver_rate;$i++)
