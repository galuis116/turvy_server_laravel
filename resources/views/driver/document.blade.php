        ...
        <div class="form-group">
            ...
            @forelse($documents as $one)
                <div class="col-md-12">
                    ...
                    <a href="{{ route('driver.document.edit', ['id' => $one['document_id']]) }}" class="card"
                        style="padding: 5px; margin-bottom: 10px;border: none; {{ isset($one['document_status']) && $one['document_status'] == 1 ? 'background-color: #e4d1d1;' : '' }}">
                        ...
                        <div class="card-body" style="justify-content:center;align-items:center;display:flex">
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="padding: 10px;text-align: left;font-weight: bold">{{ $one['document_name'] }}
                                </div>
                            </div>
                            <div class="col-md-2">
                                @if (isset($one['document_status']))
                                    @if ($one['document_status'] == 1)
                                        <div class="badge bg-green" style="background-color:green">Approved</div>
                                    @else
                                        <div class="badge bg-red" style="background-color:red">Pending</div>
                                    @endif
                                @endif
                            </div>
