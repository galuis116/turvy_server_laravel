    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Riders</h2>
                <a href="{{route('admin.user.rider.add')}}" class="btn bg-blue waves-effect pull-right"><i class="material-icons">add</i><span>New Rider</span></a>
            </div>
            <!-- Basic Examples -->
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                @foreach($riders as $index => $rider)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td><a href="{{route('admin.user.rider.show', $rider->id)}}">{{$rider->name}}</a></td>
                                        <td>
                                            {{$rider->email}}
