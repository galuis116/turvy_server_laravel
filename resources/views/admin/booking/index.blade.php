                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel panel-default" style="padding-left: 10px; padding-right:10px;">
                                            <div class="panel-body">
                                                <form id="frm-booking" class="form-horizontal" method="post" enctype="multipart/form-data" action="{{route('admin.booking.store')}}">
                                                    @csrf
                                                    <input type="hidden" id="user_id" name="user_id" value="0">
                                                    <input type="hidden" id="buyer" name="buyer" value="{{Auth::guard('admin')->user()->id}}">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="row clearfix">
                                                                        ...
                                                                        <div class="form-line">
                                                                            <select class="form-control" id="country" name="country">
                                                                                @foreach($countries as $country)
                                                                                    <option id="opt-country-{{$country->id}}" value="{{$country->id}}" phonecode="{{$country->phonecode}}">{{$country->nicename}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input class="form-control" id="phonecode" value="+93" name="phonecode" type="text" readonly="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <button type="button" id="get_details" class="btn btn-grey waves-effect">Get Details</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input name="ride_now" type="radio" id="ride_now" class="with-gap radio-col-blue" value="1" checked onclick="myFunction()"/>
                                                                        <label for="ride_now">Ride Now</label>
                                                                        <input name="ride_now" type="radio" id="ride_later" class="with-gap radio-col-blue" value="0" onclick="unclickFunction()"/>
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input class="datepicker form-control" id="datepicker" name="datepicker" placeholder="Select Date" type="text" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input class="timepicker form-control" id="timepicker" name="timepicker" placeholder="Select Time" type="text" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input type="checkbox" id="checkme" name="is_all_drivers" class="filled-in chk-col-blue"/>
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        @can('booking-create')
                                                                        <a class="btn bg-blue waves-effect" id="save" name="save">Book Now</a>
                                                                        @else
                                                                        <a class="btn bg-blue waves-effect" disabled="disabled" data-toggle="tooltip" data-placement="bottom" data-original-title="You have no permission for this process.">Book Now</a>
                                                                        @endcan
                                                                        <button type="button" id="estimate" class="btn bg-cyan waves-effect">Estimate Price</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li><b>Estimated Price </b> :  <em id="time_fare_price1">$0</em></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#vehicleType').on('change', function(){
                ...
                $.ajax({
                    ...
                    data:  {vehicleType: $(this).val(), orig_latitude: orig_latitude, orig_longitude: orig_longitude, radius: radius},
                    success:
                        function(data){
                            console.log(data);
                            $('#driver').empty();
                            $('#driver').append('<option value="none" disabled selected>Select Driver</option>');
                            $.each(data, function(key, value){
                                ele = '<option value="'+ value[0]['id']+'">'+value[0]['name']+'</option>';
                                $('#driver').append(ele);
                            });
                        }
                    });
            ...
            $('#estimate').on('click', function(){
                ...
                if(distance != '0'){
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            fare = ((parseInt(distance)*parseFloat(data['price_per_unit']))+parseFloat(data['base_ride_distance_charge']+data['new_gtl_charge']+data['gst_charge']));
        ...
        function validate() {
            ...
            if(servicetype_id == ""){ alert("Select vehicle service type"); return false; }
