                        ...
                        <div class="body">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#city" data-toggle="tab">
                                        <i class="material-icons">public</i> City
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#single" data-toggle="tab">
                                        <i class="material-icons">person</i> Single
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="all">
                                    <form class="form-horizontal" method="post" action="{{route('admin.notification.store')}}">
                                        @csrf
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="heading" name="heading" class="form-control" placeholder="message heading"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <select name="receiver" class="form-control">
                                                            ...
                                                            <option value="rider">All rider</option>
                                                            <option value="driver">All driver</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                                <button type="submit" class="btn btn-primary m-t-15 waves-effect">Send notification</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            $('#user_type').on('change', function(){
                $.ajax({
                    url: "{{route('getUsersByType')}}",
                    data: {
                        "user_type": $(this).val()
                    },
                    success: function(result){
                        $('#receiver').empty();
                        $('#receiver').append(result);
                    }
                });
            });
        });
