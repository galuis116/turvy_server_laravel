...
@php
    $title = isset($reason) ? 'Edit driver cancel reason' : 'Add driver cancel reason';
    $action = isset($reason) ? route('admin.cancelreason.driver.update', $reason->id) : route('admin.cancelreason.driver.store');
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>{{$title}}</h2>
                <a href="{{route('admin.cancelreason.driver.list')}}" class="btn bg-grey waves-effect pull-right"><i class="material-icons">keyboard_backspace</i><span>Back</span></a>
            </div>
            <!-- Basic Examples -->
