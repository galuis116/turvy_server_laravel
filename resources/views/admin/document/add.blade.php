    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>{{ $title }}</h2>
                <a href="{{ route('admin.document.document.list') }}" class="btn bg-grey waves-effect pull-right"><i
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="name" name="name" class="form-control"
                                                    placeholder="Enter document name" value="{{ $name }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="title" name="title" class="form-control"
                                                    placeholder="Enter document title" value="{{ $document_title }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea type="text" id="description" name="description" class="form-control"
                                                    placeholder="Enter document description" rows="3">{{ $description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        @if ($document->url != '')
                                                            <a href="{{ asset($document->url) }}" target="_blank">
                                                                ...
                                                                <img onerror="this.src='{{ asset('images/download.jfif') }}'"
                                                                    src="{{ asset($document->url) }}" width="190px"
                                                                    height="116px" alt="" />
