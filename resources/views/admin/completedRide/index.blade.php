                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="tab-content">
                                    ...
                                    <table class="table table-bordered table-striped js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($ride_now as $index => $ride)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>{{ $ride->rider_mobile }},<br> {{ $ride->rider_name }},<br>
                                                        {{ $ride->rider_email }}</td>
                                                    <td>
                                                    ...
                                                    <td><span style="color:#2b982b">{{ $ride->origin }}</span>-<span
                                                            style="color:coral">{{ $ride->destination }}</span></td>
                                                    ...
                                                    <td><span>
                                                            {{ getRideStatusName($ride->status) }}</span><br><span>{{ $ride->updated_at }}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        ...
                                        <tbody>
                                            @foreach ($ride_later as $index => $ride)
                                                <tr>
                                                    ...
                                                    <td><span style="color:#2b982b">{{ $ride->origin }}</span>-<span
                                                            style="color:coral">{{ $ride->destination }}</span></td>
                                                    <td>{{ $ride->payment_id == null ? 'None' : $ride->payment->name }}
                                                    </td>
                                                    <td>
                                                        Total: {{ currency_format($ride->payment_total) }} <br/>
                                                        Surge: {{ currency_format($ride->payment_surge) }} <br/>
                                ...
                                <div role="tabpanel" class="tab-pane fade @if ($tab=='ride_cancel'
                                    ) in active @endif" id="cancel">
                                    <table class="table table-bordered table-striped js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                <th>SrNo</th>
