            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="abd-footer-sidebar abd-footer-app">
                        ...
                        <ul>
                            <li><a href="{{url($homepgsetting->andriod_app_link)}}"><img src="{{ isset($homepgsetting->cdn_andriod_app_image) && $homepgsetting->cdn_andriod_app_image != '' ? $homepgsetting->cdn_andriod_app_image : asset('images/apps/ftr-play-store.png')}}" alt="Play store"></a></li>
                            <li></li>
                            <li><a href="{{url($homepgsetting->ios_app_link)}}"><img src="{{ isset($homepgsetting->cdn_ios_app_image) && $homepgsetting->cdn_ios_app_image != '' ? $homepgsetting->cdn_ios_app_image : asset('images/apps/ftr-apple-store.png')}}" alt="Apple store"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
