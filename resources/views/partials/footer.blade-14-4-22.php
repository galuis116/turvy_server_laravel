                    ...
                    <div class="abd-footer-sidebar">
                    		<div class="row">
                    			<div class="col-lg-6 col-md-6">
                    				<a class="ftr-logo" href="#"><img class="img-logo" style="object-fit: none" src="{{isset($settings['site_footer_logo']) ? asset($settings['site_footer_logo']) : asset('images/footer-logo.png')}}" alt="Footer Logo"></a>
