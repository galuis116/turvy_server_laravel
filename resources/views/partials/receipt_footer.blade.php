  ...
  float: left;
    ...
    <div class="abd-btm-footer" style="background-color: #000; line-height: 3px!important;">           
            ...
            <div class="row row-box" style="width: 100%;">
                <div class="col-md-5 abd-copyright" style="border: 0px solid #c6daff;">
                    <p style="color:white; font-size:10px;">&copy; Copyright 2020 by Turvy LTD. All Right Reserved.</p>
                </div>
                <div class="col-md-4 abd-copyright" style="border: 0px solid #c6daff;">
                    <a href="https://www.turvy.net/term-and-conditions" style="color: white;height: 20px;padding: 10px;display: inline-block;font-size:10px;">Term & conditions</a>/<a href="{{route('policy')}}" style="color: white;font-size:10px;">Privacy policy</a>
                </div>
                <div class="col-md-3">

                        <ul class="abd-social-nav" >
