...
@endphp
<footer>
	  <div class="abd-top-footer " style="background-color: #171717;padding-bottom: 30px;padding-top: 30px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="abd-footer-sidebar">
                    		<div class="row">
                    			...
                    			<div class="col-lg-6 col-md-6">
                    				 <div class="footer-ul-nav" id="footer-ul-nav">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="abd-footer-sidebar abd-footer-app">
                        ...
                        <div style="border:1px solid #fff;border-radius:10px;padding: 10px;">
                        		...
                        		<li><a href="{{url($ftlink2->link)}}">{{$ftlink3->label_link}}</a></li>
                         @endforeach
