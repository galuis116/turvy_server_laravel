...
<!-- First row finihs -->
    ...
    <div class="row row-box" >
	           ...
	           <div class="col-md-3" style=" ">
				...
				<div class="col-md-3" style=" ">
				  <p class="recepit-text-label">Vehicle</p>
					<p class="receipt-text">{{$recepit_data['make']}}  {{$recepit_data['model']}} <br />{{$recepit_data['color']}} </p>
				</div>
				...
				<div class="col-md-2" style=" ">
				 <p class="recepit-text-label">Duration</p>
					<p class="receipt-text">{{$recepit_data['trip_duration']}}</p> 
				</div>
				<div class="col-md-2" style="">
			...
			<br />
			<div class="row row-box" style="padding-top: 20px;padding-bottom: 20px;">
					<div class="col-md-2"></div>
	           <div class="col-md-4">
					<p style=" font-size: 28px;font-weight: 700;">Total</p>
	           </div>
  ...
  font-weight: 700;
			...
			<div class="row row-box" style="padding-bottom: 30px;">
				...
				<div class="col-md-6" style="text-align: right;  padding-top: 20px;padding-right: 0px;font-weight: 600;">
					@if (isset($surchagrearr->gst_amt) )  
						A${{number_format($surchagrearr->gst_amt,2)}} 
					@endif 
				</div>
			</div>
			...
			<div class="row row-box" style=" border-top: 1px solid #c6daff;padding-top: 25px;">
				<div class="col-md-12" style="text-align: left;padding-top: 20px;padding-left: 0px; text-align: left!important;"><strong>Amount Charged</strong></div>
			</div>


			<div class="row row-box" style=" border-bottom: 0px solid steelblue;">
				<div class="col-md-6" style="text-align: left;padding-top: 10px;padding-left: 0px;"><p class="receipt-text">{{$recepit_data['paymenthod']}}</p></div>

				<div class="col-md-6" style="text-align: right; padding-top: 10px;padding-right: 0px;"><p class="receipt-text">A${{$recepit_data['total']}}</p></div>
			</div>
