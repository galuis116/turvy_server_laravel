...
{{$recepit_data['paymenthod']}}
			    ...
			    <div class="p-5 border-bottom-1"><i class="fa fa-cloud-download" aria-hidden="true"></i>&nbsp;&nbsp; Download PDF</div>
			    <div>&nbsp;</div>
				<div class="p-5"><i class="fa fa-envelope" aria-hidden="true"></i> &nbsp;&nbsp; Resend Email</div>
