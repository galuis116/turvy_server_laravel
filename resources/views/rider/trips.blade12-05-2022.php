  ...
  <div class="tab-content" >
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <table > <tr> <td style="text-align: left;" class="col-md-5">{{$ride->booking_date}} , {{$ride->booking_time}}</td> <td  class="col-md-6">{{trim($ride->origin)}}</td></tr></table></a>
      ...
      <div id="collapse{{$key}}" class="panel-collapse collapse">
        <div class="panel-body">CONTENTS FOR TAB </div>
      </div>
