...
class DriverController extends Controller
{
    ...
    public function endBook(Request $request, $book_id)
    {
        ...
        $tripFare = $this->calculateTripAmount($trip_distance, $ride->servicetype_id);
    ...
    public function calculateTripAmount($distance=0, $servicetype_id)
    {
        if($servicetype_id <= 0)
            return false;
        ...
        if($fare){
            ...
            $gstCal = ($subTotal+$surcharge) * ($gst/100);
            ...
            $driverAmount = $totalAmt - $company_amount;
  	...
  	public function getDriverEarning($page)
    {
        ...
        ->get();
      	...
      	foreach($transactions as $k => $item){
            ...
            $transactions[$k]['amount'] = number_format($item['amount'],2);
